...
Here we show the individual elements that make up the WFD Biological Quality Elements classification. They show waterbody and WFD site level data. Should you wish to access non-WFD ecological monitoring data please visit: [Link to Phil C Wessex Explorer]

The below pop-up plots show the interim WFD classification in 2022, at both a waterbody and site level.
...
Invertebrates have been used to assess the ecological health of rivers as they acts as biotic indicators for water quality, habitat diversity and hydrological pressures whilst unlike fish or macrophytes, their abundance is less impacted by barriers.
...
A combined classification element, macrophytes & phytobenthos provide  The method has been designed to reflect the impact on the quality element of nutrient
enrichment. It may also be sensitive to some other anthropogenic pressures, including alterations to river flows and modifications to morphological conditions which may act alone or in combination to affect the macrophyte community. 
...
This initial evidence pack doesn't include any ecological Water Company data (for this refer to: LINK TO PHIL C Dashboard), only data taken directly from the Riverfly Partnership. Third-parties often have a different or un-aligned monitoring agenda to the Environment Agency. Eventually through influence, priorities can be aligned, however, initially data may not be exactly where the EA would require it. Here we view a site mean for data from 2019 onwards.
