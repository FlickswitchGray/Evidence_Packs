...
leaflet() %>% 
  ...
  addCircleMarkers(data = inv_2022,
                   ...
                   fillOpacity = 1,
                   options = pathOptions(zIndex = 999),
                   popup = paste0("WHPT Mean Score: ",inv_2022$WHPT_TOTAL_Mean,                        #Bit random dates? Check mean is calculated correctly. Also isn't it WHPT we should show not BMWP? I think the columns may be messed up as ANALAYSIS_ID is our date.
                                  
                                  "<br> Sample Range: ", range(inv_2022$Sample_Date_Maybe))
                   )%>% 
