...
RNAG <- CPS %>% filter(OPERATIONAL_CATCHMENT == "Parrett")
RNAG <- inner_join(CAT_geo, RNAG, by = c("WB_ID" = "WATERBODY_ID"))
...
DT::datatable(RNAG[,c(1,5,6,10,17:21,23:35)],
