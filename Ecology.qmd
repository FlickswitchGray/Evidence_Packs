...
For catchment management and river restoration to be effective, measures should benefit ecology. Without a clear line-of-sight between how a measure will have a positive ecological impact, the success of the impact and the investment into this is of limited value.
...
Here we show the individual elements that make up the WFD Biological Quality Elements classification. They show waterbody and WFD site level data. Should you wish to access non-WFD monitoring data please visit:
