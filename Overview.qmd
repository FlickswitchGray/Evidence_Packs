...
BW <- read_excel("/dbfs/FileStore/WSX_HGray/Bathing_Water_Sites_Comms_Phil_C_Nov_24.xlsx")

leaflet() %>%
      addProviderTiles(providers$Esri, group="Esri Basemap")%>%
      addCircleMarkers(data=BW,
                      radius = 10,
                      color = "black",
                      weight = 1,
