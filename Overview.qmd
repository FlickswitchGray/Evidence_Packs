...
# Could you insert a similar map to above here
...
The most recent classifications can still be rolled-over due to a hiatus in monitoring in certain catchments (or should this be certain classification items?), this can mean that updated classifications aren't representative of environmental conditions in that year but are an interpretation of previous year's classifications. Figure 2 [Insert hyperlink here] shows the waterbodies for which classifications have been rolled over [insert below]. 
