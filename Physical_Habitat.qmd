...
The below map shows waterbodies in the `r unique(CAT$OPCAT_NAME)` which have morphology as their SWMI. Reach-level data on morphology can be viewed by clicking the River Habitat Survey (RHS) box in the top right.
