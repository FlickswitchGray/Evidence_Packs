...
The below map shows data from the Agricultural Land Environmental Risk Tool ([ALERT](https://defra.sharepoint.com/:u:/r/teams/Team646/SitePages/A.L.E.R.T-Home-Page.aspx?csf=1&web=1&e=hPErKt)), it models diffuse pollution pathways and quantifies diffuse pollution risk. Created by Geomatics EA, it is commonly used in farm inspection visits. The below map calculates  based on: 
- Land-use 
- Hill slope 
- Erosion and runoff risk of soil 
- Mean precipitation

It is commonly used on farm inspection visits. 

The below map provides a mean score of diffuse pollution per waterbody using the data from ALERT, there is also the option of viewing diffuse pollution pathways at a reach scale.
