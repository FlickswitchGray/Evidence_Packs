...
Phys_Chem_Site <- readxl::read_excel("C:/Users/hg000051/Downloads/2022 Phys-Chem Classification QA document (RAW).xlsx", sheet= "Site Class")
...
pal_p <- colorBin(palette = "inferno", domain = WIMS_p$result, bins = binz, reverse=TRUE )
    ...
    leaflet() %>%
      ...
      addPolygons(data= CDE_P,
                  ...
                  color = "black",
                  weight= 0.1,
                  popup = paste0("Status: ", CDE_P$Status),
      ...
      addCircleMarkers(
       ...
       addCircleMarkers(data=Site_P,
                        ...
                        fillColor = ~pal(Class),
                        fillOpacity = 1,
                        popup = ~paste0("<br> 2022 WFD Status: ", Site_P$Class,
                                        "Site: ", Site_P$SITE_NAME, 
                                        "<br> ID: ", Site_P$SITE_ID,
                                        "<br> Status Compliance: ", Site_P$Compliance, "What does this mean?",
                                        "<br> Mean: ", Site_P$Mean,
                                        "<br> Sample Range: ", Site_P$From_Yr, " - ", Site_P$To_Yr),
       ...
       addLayersControl(baseGroups = c("Esri","Blank Basemap"), 
                       ...
                       options=layersControlOptions(collapsed=FALSE)) %>% 
       hideGroup(c( 
                  "Waterbodies", "2022? Phosphate WB Status", "2022 WFD Site Status"))
...
leaflet() %>%
      addProviderTiles(providers$Esri, group="Esri") %>% 
       ...
       addCircleMarkers(data=Site_Am,
                        ...
                        fillColor = ~pal(Class),
                        fillOpacity = 1,
                        popup = ~paste0("<br> 2022 WFD Status: ", Site_Am$Class,
                                        "Site: ", Site_Am$SITE_NAME, 
                                        "<br> ID: ", Site_Am$SITE_ID,
                                        "<br> Status Compliance: ", Site_Am$Compliance, "What does this mean?",
                                        "<br> Mean: ", Site_Am$Mean,
                                        "<br> Sample Range: ", Site_Am$From_Yr, " - ", Site_Am$To_Yr),
                        group = "2022 WFD Site Status"
                        ) %>% 
       addLegend("bottomleft", 
                      pal = pal_am, 
