...
The below map shows data from the Agricultural Land Environmental Risk Tool ([ALERT](https://defra.sharepoint.com/:u:/r/teams/Team646/SitePages/A.L.E.R.T-Home-Page.aspx?csf=1&web=1&e=hPErKt)), it models diffuse pollution pathways and quantifies diffuse pollution risk. Created by Geomatics EA, it is commonly used in farm inspection visits, the diffuse pollution risk scores are based on: 
- Land-use 
- Hill slope 
- Erosion and runoff risk of soil 
- Mean precipitation

Why is this modelled risk, not actual risk? From in-river water quality monitoring, we can monitor the amount of soil lost from catchments to rivers but this is confined to water quality monitoring sites.
