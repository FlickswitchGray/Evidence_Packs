...
The below map provides the whereabouts of continuous permitted WWtW and their likelihood of eutrophication, as well as the option to view intermittent CSO discharges for 2023. These provide some indication of the pressure from point source pollution on waterbodies. Point source pollution from fish farms and private consented discharges are not mapped here.
...
The below map shows data from the Agricultural Land Environmental Risk Tool ([ALERT](https://defra.sharepoint.com/:u:/r/teams/Team646/SitePages/A.L.E.R.T-Home-Page.aspx?csf=1&web=1&e=hPErKt)), it models diffuse pollution pathways and quantifies diffuse pollution risk. Created by the Geomatics team, EA, it is commonly used by agricultural teams in farm visits, the diffuse pollution risk scores are based on: 
- Land-use (most recent)
- Hill slope 
- Erosion and runoff risk of soil 
- Mean precipitation

Why is this modelled risk, not actual risk? From in-river water quality monitoring, we can monitor the amount of soil lost from catchments to rivers but this is confined to monitoring sites. This tool mo
...
leaflet() %>%
      addProviderTiles(providers$Esri, group="Esri") %>% 
       ...
       addCircleMarkers(
                      ...
                      popup = ~paste0("Site: ", WIMS_am$sample.samplingPoint.label, "<br> Mean PO4-P (mg/L): ", WIMS_am$Mean_A, "<br> Sample Count: ", WIMS_am$Mean_count,
                                      "<br> from/to: ",
