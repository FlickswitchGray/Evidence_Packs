...
RNAGs for Hydrological Regime Elements are displayed in the map below, they are filtered to show the most recent RNAGs, those which are opaque are >5 years old and have a creation date of 1st January 2019. 
...
# Abstraction RNAG Review

The below table provides information on abstraction issues within the Parrett catchment. 
