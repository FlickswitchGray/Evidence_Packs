...
# Define palette
pal <- colorFactor(
  palette = c("#ADE8F4", "seagreen", "seagreen", "yellow", "orange", "#b71105", "red","red"),
  levels = c("High", "Good", "Supports Good", "Moderate", "Bad", "Poor", "Fail", "Does Not Support Good"),
...
```
Water Resources captures the availability of water within rivers, lakes and groundwater aquifers, 
...
The hydrological cycle naturally varies and, at certain flow levels, can become an ecological stressor. Abstraction license summaries provide information on hydrology as a pressure at different river flow levels. The map below visualizes abstraction at Q50, or average flow, which occurs 50% of the time. Q95 shows water availability during dry periods when low flows are common, while Q30 represents conditions when high flows are common.
