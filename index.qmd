...
This Catchment Evidence Pack is for the `r unique(CAT$OPCAT_NAME)` operational catchment, as defined under the Water Framework Directive (WFD). It includes information on catchment pressures and provides access to data at a catchment, waterbody and site scale. It draws together a range of information and evidence to help us better understand the environmental condition, pressures and opportunities within the catchment. 
